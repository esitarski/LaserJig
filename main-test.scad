...
lasercutout(thickness = 18, 
          points = [[0, 0], [0, 1101.95], [68.2203, 1064.14], [191.088, 275.488], [427.72, 18], [427.72, 0]]
        , milling_bit = 10
        ) 

lasercutout(thickness = 18, 
          points = [[0, 0], [0, 50.8], [397.577, 50.8], [427.72, 18], [427.72, 0]]
        , milling_bit = 10
        ) 
...
lasercutout(thickness = 18, 
          points = [[0, 0], [183, 0], [183, 340.324], [0, 340.324], [0, 0]]
        , milling_bit = 10
        ) 

lasercutout(thickness = 18, 
          points = [[0, 0], [36, 0], [36, 340.324], [0, 340.324], [0, 0]]
        , milling_bit = 10
        ) 
...
lasercutout(thickness = 18, 
          points = [[0, 0], [9.375, 0], [9.375, 130], [0, 130], [0, 0]]
        ) 
...
lasercutout(thickness = 18, 
          points = [[0, 0], [1500, 0], [1500, 1270.86], [0, 1270.86], [0, 0]]
        , milling_bit = 10
        ) 

lasercutout(thickness = 18, 
          points = [[0, 0], [0, 590], [67.5, 446.667], [67.5, 167.5], [220, 18], [220, 0]]
        , milling_bit = 10
        ) 

lasercutout(thickness = 18, 
          points = [[0, 0], [0, 50.8], [186.542, 50.8], [220, 18], [220, 0]]
        , milling_bit = 10
        ) 
...
lasercutout(thickness = 18, 
          points = [[0, 0], [0, 670], [150.5, 670], [150.5, 602], [90, 502.5], [90, 167.5], [220, 18], [220, 0]]
        , milling_bit = 10
        ) 

lasercutout(thickness = 18, 
          points = [[0, 0], [0, 50.8], [191.478, 50.8], [220, 18], [220, 0]]
        , milling_bit = 10
        ) 
